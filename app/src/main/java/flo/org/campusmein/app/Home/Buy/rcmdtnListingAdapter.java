 ...
 */
public class rcmdtnListingAdapter extends RecyclerView.Adapter<rcmdtnListingAdapter.MyViewHolder> {
...
//            overflow = (ImageView) view.findViewById(R.id.overflow);
    ...
    public rcmdtnListingAdapter(Context mContext, List<Products> productList) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.product_card_horizontal, parent, false);
...
//                        ((BuyFragment)mContext).invalidateOptionsMenu();
//                        return true;
