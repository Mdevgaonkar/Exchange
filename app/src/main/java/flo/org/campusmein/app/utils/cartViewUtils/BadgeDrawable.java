package flo.org.campusmein.app.utils.cartViewUtils;
...
public class BadgeDrawable extends Drawable {
    ...
    public BadgeDrawable(Context context) {
        ...
        mBadgePaint.setColor(context.getResources().getColor(R.color.colorBadge));
        mBadgePaint.setAntiAlias(true);
        mBadgePaint.setStyle(Paint.Style.FILL);
        mBadgePaint1 = new Paint();
        mBadgePaint1.setColor(ContextCompat.getColor(context.getApplicationContext(), R.color.colorOptionsMenu));
